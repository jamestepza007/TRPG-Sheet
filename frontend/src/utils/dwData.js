...
<<<<<<< HEAD
      ...
      { tier: '5th Level', name: 'True Seeing', description: '(ongoing) Your vision is opened to the true nature of everything you lay your eyes on. You pierce illusions and see things that have been hidden. The GM will describe the area before you ignoring any illusions and falsehoods, magical or otherwise. While this spell is ongoing you take -1 to cast a spell.' },
      { tier: '5th Level', name: 'Contagion', description: '(ongoing) Choose a creature you can see. Until you end this spell, the target suffers from a disease of your choice. While this spell is ongoing you take -1 to cast a spell.' },
      { tier: '5th Level', name: 'Trap Soul', description: 'You trap the soul of a dying creature within a gem. The trapped creature is aware of its imprisonment but can still be manipulated through spells, parley, and other effects. All moves against the trapped creature are at +1. You can free the soul at any time but it can never be recaptured once freed.' },
      { tier: '5th Level', name: 'Words Of The Unspeaking', description: 'With a touch you speak to the spirits within things. The non-living object you touch answers three questions you pose, as best it can.' },
      { tier: '7th Level', name: 'Word Of Recall', description: 'Choose a word. The first time after casting this spell that you speak the chosen word, you and any allies touching you when you cast the spell are immediately returned to the exact spot where you cast the spell. You can only maintain a single location; casting Word of Recall again before speaking the word replaces the earlier spell.' },
      { tier: '7th Level', name: 'Heal', description: 'Touch an ally and you may heal their damage a number of points up to your maximum HP.' },
      { tier: '7th Level', name: 'Harm', description: 'Touch an enemy and strike them with divine wrath—deal 2d8 damage to them and 1d6 damage to yourself. This damage ignores armor.' },
      { tier: '7th Level', name: 'Sever', description: '(ongoing) Choose an appendage on the target such as an arm, tentacle, or wing. The appendage is magically severed from their body, causing no damage but considerable pain. Missing an appendage may, for example, keep a winged creature from flying. While this spell is ongoing you take -1 to cast a spell.' },
      { tier: '7th Level', name: 'Mark Of Death', description: 'Choose a creature whose true name you know. This spell creates permanent runes on a target surface that will kill that creature, should they read them.' },
      { tier: '7th Level', name: 'Control Weather', description: 'Pray for rain—or sun, wind, or snow. Within a day or so, your god will answer. The weather will change according to your will and last a handful of days.' },
      { tier: '9th Level', name: 'Storm Of Vengeance', description: "Your deity brings the unnatural weather of your choice to pass. Rain of blood or acid, clouds of souls, wind that can carry away buildings, or any other weather you can imagine: ask and it shall come." },
      { tier: '9th Level', name: 'Repair', description: "Choose one event in the target's past. All effects of that event, including damage, poison, disease, and magical effects, are ended and repaired. HP and diseases are healed, poisons are neutralized, magical effects are ended." },
